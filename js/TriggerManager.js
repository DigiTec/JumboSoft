    ...
    value: (function _initTriggerManager() {
      ...
      function _evaluateTriggersInternal(triggerParent, triggerableObjects) {
        triggerableObjects.forEach(function(triggerableObject) {
          ...
          if (
            triggerableObject.subObjects &&
            triggerableObject.subObjects.length > 0
          ) {
            _evaluateTriggersInternal(
              triggerableObject,
              triggerableObject.subObjects
            );
          }
      ...
      Object.defineProperties(_triggerManager, {
        addTriggerableObject: {
          value: function addTriggerableObject(triggerableObject) {
            if (!(triggerableObject instanceof TriggerableObject)) {
              throw new Error(
                "Parameter triggerableObject is not an instance of TriggerableObject"
              );
            }
            if (_triggerableObjects.indexOf(triggerableObject) >= 0) {
              throw new Error(
                "Parameter triggerableObject has already been registered with this TriggerManager"
              );
            }
        ...
        addTriggers: {
          value: function addTriggers(triggerObject) {
            ...
            if (!Array.isArray(triggers)) {
              throw new Error(
                "Parameter triggerObject does not contain a property triggerNames which is an array"
              );
            }
            triggers.forEach(function(triggerName) {
              if (triggerName in _triggerObjects) {
                throw new Error(
                  "The trigger " +
                    triggerName +
                    " is already supported by another object"
                );
              }
        ...
        save: {
          value: function save(rootObject) {
            _triggerableObjects.forEach(function _saveSubObjects(
              triggerableObject
            ) {
        ...
        load: {
          value: function load(rootObject) {
            _triggerableObjects.forEach(function _loadSubObjects(
              triggerableObject
            ) {
