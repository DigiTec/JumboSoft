...
(function _initUpgradeUI() {
    function _attachUpgrade(uiElement, upgrade) {
        ...
        uiElement.listener = _clickUpgradeButton.bind({ ui: this, uiElement: uiElement });
        ...
        notifyPropertyChanged: {
            value: function notifyPropertyChanged(property) {
                switch (property) {
                    ...
                    default:
                        throw new Error("Unexpected property sent to UpgradeUI: " + property);
                }
            }
        },
        ...
        update: {
            value: function update() {
                if (this.upgradesChanged) {
                    ...
                    if (this.upgradeSlots.length > 0 && this.units.triggeredUpgrades.length > 0) {
                        this.units.triggeredUpgrades.sort(function (upgradeA, upgradeB) {
