...
(function() {
  function _createAchievementList(trigger, names, values, description) {
    ...
    for (var i = 0; i < names.length; i++) {
      ...
      achievements.push(
        new Achievement(name, formattedDescription, [
          { name: trigger, value: value }
        ])
      );
    }
  ...
  Object.defineProperties(AchievementList.prototype, {
    ...
    init: {
      value: function init() {
        ...
        this.totalStock = _createAchievementList(
          "totalStocks",
          [
            "Intern",
            "SDE",
        ...
        var _stockPerSecond = _createAchievementList(
          "stockTicker",
          [
            "Wet Feet",
            "Dabbler",
        ...
        var _totalManualStock = _createAchievementList(
          "handMadeStocks",
          [
            "Janitor",
            "Working Hard",
        ...
        var _totalManualClicks = _createAchievementList(
          "clicks",
          [
            "Love That Sound",
            "Serious Clicks",
        ...
        var _individualUnitCounts = [].concat(
          _createAchievementList(
            "automation",
            ["Auto Mate", "No Complaints", "Robots Rights", "Sky Net"],
            [1, 20, 50, 100],
            "Acquired %d Automation Assets"
          ),
          _createAchievementList(
            "contractor",
            ["Hired Help", "Disposable Army", "Redundancy", "Office Space"],
            [1, 20, 50, 100],
            "Acquired %d Contractors"
          ),
          _createAchievementList(
            "hardware",
            [
              ...
              "Warming Up In Here",
              "Super Computer",
              "Artficially Intelligent"
            ],
            [1, 20, 50, 100],
            "Acquired %d Hardware Assets"
          ),
          _createAchievementList(
            "blueBadge",
            [
          ...
          _createAchievementList(
            ...
            [
              ...
              "Global Warming",
              "Power Overwhelming",
              "A Lab On Every Desktop"
            ],
            [1, 20, 50, 100],
            "Acquired %d Lab Spaces"
          ),
          _createAchievementList(
            "architect",
            ["I Assert!", "Refactored", "Patterned", "Slipped"],
            [1, 20, 50, 100],
            "Acquired %d Software Architects"
          ),
          _createAchievementList(
            "acquisition",
            [
              "That Was Easy!",
              "Stick Em Up!",
              "Like Eating Tic-Tacs",
              "Corporate Boogeyman"
            ],
            [1, 20, 50, 100],
            "Acquired %d Companies"
          ),
          _createAchievementList(
            "cloud",
            [
            ...
            [1, 20, 50, 100],
            "Acquired %d Clouds, Whatever The Hell That Means"
          )
        );
        var _totalUnitCounts = _createAchievementList(
          "totalUnits",
          [
            "Started in a Garage",
            "Startup",
        ...
        var _upgradeCounts = _createAchievementList(
          "totalUpgrades",
          ["I know Kung Fu", "Hardware Enthusiast", "Tech Addict!", "The Borg"],
          [1, 5, 25, 50],
          "Install %d upgrades."
        );
        var _yearMilestones = _createAchievementList(
          "gameYears",
          [
            "Stock Vest",
            "Red Annivesary",
            ...
            "Blue Anniversary",
            "Oversized Crystal",
            "Monstrously Large Crystal",
            "Absurdly Large Crystal",
        ...
        this.subObjects = [].concat(
          this.totalStock,
          _stockPerSecond,
          _totalManualStock,
          _totalManualClicks,
          _individualUnitCounts,
          _totalUnitCounts,
          _upgradeCounts,
          _yearMilestones
        );
