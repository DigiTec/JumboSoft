...
Object.defineProperties(UnitList.prototype, {
        ...
        value: function changeUpgrades(triggeredObject) {
            ...
            if (triggeredObject.unlocked) {
                ...
                if (!triggeredObject.triggered) {
                    throw new Error("Object was used in an upgrades notification but was not unlocked or triggered.");
                }
            ...
            switch (triggerName) {
                case "totalUnits":
                    if (this.unitsChanged) {
                        ...
                        this.totalUnits = this.stockValueObjects.reduce(function _reduceUnitListUnits(prev, curr) {
                ...
                case "totalUpgrades":
                    if (this.upgradesChanged) {
                        ...
                        this.totalUpgrades = this.subObjects.reduce(function _reduceUnitListUpgrades(prev, curr) {
    ...
    init: {
        value: function init() {
            ...
            this.manualTesting = new Unit(this, "Manual Testing", "manual", "", 0, 0, 1, Upgrades.clickUpgrades.concat(Upgrades.handMadeUpgrades));
            this.manualTesting.buy();
            this.stockValueObjects = [
                new Unit(this, "Automation Software", "automation", "",
                    20, 1.15, 0.2, Upgrades.automationUpgrades),
                new Unit(this, "Contractor", "contractor", "",
                    120, 1.15, 1, Upgrades.contractorUpgrades),
                new Unit(this, "New Hardware", "hardware", "",
                    600, 1.17, 6, Upgrades.hardwareUpgrades),
                new Unit(this, "Blue Badge", "blueBadge", "",
                    4000, 1.17, 32, Upgrades.blueBadgeUpgrades),
                new Unit(this, "Computer Lab", "labs", "",
                    24000, 1.18, 128, Upgrades.labsUpgrades),
                new Unit(this, "Architect", "architect", "",
                    75000, 1.18, 512, Upgrades.architectUpgrades),
                new Unit(this, "Acquisition", "acquisition", "",
                    300000, 1.19, 2048, Upgrades.acquisitionUpgrades),
                new Unit(this, "The Cloud", "cloud", "",
                    2000000, 1.22, 16384, Upgrades.cloudUpgrades),
            ];
    ...
    computeStockValue: {
        value: function computeStockValue() {
            return this.stockValueObjects.reduce(function _reduceUnitsStockValue(prev, curr) {
